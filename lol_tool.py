...
class AutoEngine:
    ...
    def _handle_party_ready(self):
        ...
        try:
            ...
            # Sound: remind ME to ready up once all OTHER tool users are ready —
            # but never once I've readied up myself, even if that happens while
            # the 30s reminder delay is still counting down.
            ...
            should_remind    = all_others_ready and not self._i_am_ready
            if should_remind and not self._others_ready_notified:
